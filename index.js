...
var objectPattern = {
    fetcher: function fetcher() {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetch("http://localhost:5001", {
                            method: "get"
                        })];
                    case 1:
                        req = _a.sent();
    ...
    clicker: function clicker(e) {
        return __awaiter(this, void 0, void 0, function () {
            var child, h1, text, param, req, ret;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        child = e.target;
                        h1 = Array.from(child.parentElement.parentElement.children)[1].children[0];
                        text = h1.innerText;
                        param = {
                            text: text
                        };
                        return [4 /*yield*/, fetch("http://localhost:5001/rent", {
                                method: "post",
